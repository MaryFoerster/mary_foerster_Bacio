<nav class="navbar navbar-expand-md pt-3 pb-3 sticky-top bg-none">
    <div class="container">
      <a class="navbar-brand bg-red p-2 custom-radius" href="index.php"><img id="bacio-logo" class="logo-nav" src="img/bacio-logo-white.png" alt="bacio-logo" title="bacio-logo"/></a>
      <button class="navbar-toggler bg-red custom-radius" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
        <span><img class="img-nav" src="img/burger-white.png" alt="burger-menu" title="burger-menu"></span>
      </button>
