...
<section>
        ...
        <h2 class="titel-h4">Kontaktdaten des Verantwortlichen
        </h2>
        <p>Sollten Sie Fragen zum Datenschutz oder zur Verarbeitung personenbezogener Daten haben, finden Sie
          ...
          6020 Innsbruck <br>
          Österreich <br>
          Vertretungsberechtigt: Armando Ammirati <br>
          E-Mail: mail@pizzabacio.com <br>
          Telefon: +43 664 4132694 <br>
          Impressum: pizzabacio.com <br>
        </p>
        <h2 class="titel-h4">Einleitung und Überblick</h2>
        <p>Wir haben diese Datenschutzerklärung (Fassung 18.06.2024-122818254) verfasst, um Ihnen gemäß der Vorgaben der
        ...
        <p>Datenschutzerklärungen klingen für gewöhnlich sehr technisch und verwenden juristische Fachbegriffe. Diese
          ...
          informativ und vielleicht ist die eine oder andere Information dabei, die Sie noch nicht kannten.</p>
        <p>Wenn trotzdem Fragen bleiben, möchten wir Sie bitten, sich an die unten bzw. im Impressum genannte
        ...
        <h2 class="titel-h4">Anwendungsbereich</h2>
        ...
        <ul>
          <li>alle Onlineauftritte (Websites, Onlineshops), die wir betreiben
          </li>
          <li>Social Media Auftritte und E-Mail-Kommunikation
          </li>
          <li>mobile Apps für Smartphones und andere Geräte
          </li>
        </ul>
        ...
        <h2 class="titel-h4">Rechtsgrundlagen </h2>
        <p>In der folgenden Datenschutzerklärung geben wir Ihnen transparente Informationen zu den rechtlichen
          ...
          https://eur-lex.europa.eu/legal-content/DE/ALL/?uri=celex%3A32016R0679 nachlesen.</p>
        <ul>Wir verarbeiten Ihre Daten nur, wenn mindestens eine der folgenden Bedingungen zutrifft: <br>
          <lo>1. Einwilligung (Artikel 6 Absatz 1 lit. a DSGVO): Sie haben uns Ihre Einwilligung gegeben, Daten zu einem
            bestimmten Zweck zu verarbeiten. Ein Beispiel wäre die Speicherung Ihrer eingegebenen Daten eines
            Kontaktformulars.</lo> <br><br>
          <lo>2. Vertrag (Artikel 6 Absatz 1 lit. b DSGVO): Um einen Vertrag oder vorvertragliche Verpflichtungen mit
            Ihnen zu erfüllen, verarbeiten wir Ihre Daten. Wenn wir zum Beispiel einen Kaufvertrag mit Ihnen
            abschließen, benötigen wir vorab personenbezogene Informationen.</lo> <br><br>
          <lo>3. Rechtliche Verpflichtung (Artikel 6 Absatz 1 lit. c DSGVO): Wenn wir einer rechtlichen Verpflichtung
            unterliegen, verarbeiten wir Ihre Daten. Zum Beispiel sind wir gesetzlich verpflichtet Rechnungen für die
            Buchhaltung aufzuheben. Diese enthalten in der Regel personenbezogene Daten.</lo> <br><br>
          <lo>4. Berechtigte Interessen (Artikel 6 Absatz 1 lit. f DSGVO): Im Falle berechtigter Interessen, die Ihre
            Grundrechte nicht einschränken, behalten wir uns die Verarbeitung personenbezogener Daten vor. Wir müssen
            zum Beispiel gewisse Daten verarbeiten, um unsere Website sicher und wirtschaftlich effizient betreiben zu
            können. Diese Verarbeitung ist somit ein berechtigtes Interesse.</lo>
        </ul>
        ...
        <ul>
          <li>In Österreich ist dies das Bundesgesetz zum Schutz natürlicher Personen bei der Verarbeitung
            personenbezogener Daten (Datenschutzgesetz), kurz DSG.</li>
          <li>
            In Deutschland gilt das Bundesdatenschutzgesetz, kurz BDSG.</li>
        </ul>
        <p>Sofern weitere regionale oder nationale Gesetze zur Anwendung kommen, informieren wir Sie in den folgenden
          ...
          <h2 class="titel-h4">Speicherdauer </h2>
      <p>Dass wir personenbezogene Daten nur so lange speichern, wie es für die Bereitstellung unserer Dienstleistungen
        ...
        Daten so rasch wie möglich und soweit keine Pflicht zur Speicherung besteht, gelöscht. <br>
